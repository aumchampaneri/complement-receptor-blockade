#!/usr/bin/env python3
"""
Multi-Resource LIANA Receptor-Ligand Analysis & Consensus Aggregation for Lupus EMTAB
====================================================================================
...
INPUT:
    - AnnData: /Users/aumchampaneri/complement-receptor-blockade/data/lupus-emtab/emtab_annotated.h5ad
...
OUTPUT:
    ...
    - Consensus table:
        /Users/aumchampaneri/complement-receptor-blockade/outputs/lupus-emtab/rla/consensus_complement_interactions.csv

ENVIRONMENT:
    - Python >=3.8
    - liana, scanpy, pandas, mygene

AUTHOR: Automated Pipeline (multi-resource, lupus EMTAB)
DATE: 2024-06
"""
...
# ------------------- Configurable Paths -------------------
DATA_PATH = "/Users/aumchampaneri/complement-receptor-blockade/data/lupus-emtab/emtab_annotated.h5ad"
GENE_LIST_PATH = (
    "/Users/aumchampaneri/complement-receptor-blockade/resources/complement-genes.txt"
)
OUTDIR = "/Users/aumchampaneri/complement-receptor-blockade/outputs/lupus-emtab/rla/"
