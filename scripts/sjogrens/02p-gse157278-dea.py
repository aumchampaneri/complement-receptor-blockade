...
This script visualizes differential expression (DE) results for complement genes
from robust pseudo-bulk DESeq2 analysis of the Sjögren’s GSE157278 PBMC dataset.

Key features:
- Volcano plots for each cell type (highlighting complement genes)
- Heatmap of log2 fold changes (complement genes × cell types)
- Dotplot of -log10(padj) for complement genes across cell types
...
- (Optional) AnnData object for expression plots: gse157278_processed_celltypist.h5ad
...
def plot_umaps_alt_pathway(plotdir, logger):
    ...
    try:
        ...
        logger.warning("anndata or scanpy not installed; skipping UMAP plots.")
        return
