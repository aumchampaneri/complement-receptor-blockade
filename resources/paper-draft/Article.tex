...
\begin{abstract}
	Sjögren's Syndrome (SS) and Systemic Lupus Erythematosus (SLE) are chronic autoimmune diseases with characteristic aberrant immune activation, autoanitbody production, and end-organ inflammation. Evidence has long implicated aberrant complement activation as a central driver of disease pathogenesis in both SS and SLE.. Specifically, dysregulation of C3 and C5 within the alternative pathway has mediated tissue injury in SS and SLE. Complement receptor 1 (CR1/CD35) plays an important role in clearance of circulating immune complexes and apoptotic debris; a mechanism altered in SLE via defective CR1 expression on erythrocytes. Impairment of this critical clearance mechanism accumulation of pro-inflammatory immune factors such as C3b and C4b; driving sustained type I interferon signaling and subsequent tissue injury. 
	
	This paper aims to use publicly available high-throughput sequencing data to elucidate the therapeutic efficacy of the alternative pathway of the complement cascade. 
\end {abstract}
%TC:break main
%the command above serves to have a word count for the abstract
